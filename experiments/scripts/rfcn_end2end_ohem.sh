...
time ./tools/train_net.py --gpu ${GPU_ID} \
  --solver models/${PT_DIR}/${NET}/deformable_rfcn_end2end/solver_ohem.prototxt \
#  --weights resnet50_rfcn_ohem_caffemodel/deformable__resnet50_rfcn_ohem_caffemodelm_iter_8000.caffemodel \
  --imdb ${TRAIN_IMDB} \
  --iters ${ITERS} \
