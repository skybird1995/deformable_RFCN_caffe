#ifndef CAFFE_DEFORMABLE_PSROI_POOLING_HPP_
#define CAFFE_DEFORMABLE_PSROI_POOLING_HPP_
 ...
 * @param param provides PSROIAlignParameter psroi_align_param,
 *        with PSROIAlignLayer options:
...
class DeformablePSROIPoolLayer : public Layer<Dtype> {
 public:
  explicit DeformablePSROIPoolLayer(const LayerParameter& param)
    : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return " DeformablePSROIPool"; }
 ...
 // Blob<Dtype> sample_pos_;
  //int sample_num_;
};

}  // namespace caffe

#endif  // CAFFE_PSROI_ALIGN_LAYER_HPP_
